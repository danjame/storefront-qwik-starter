...
export const DEFAULT_METADATA_URL = 'https://pt.lotactree.com/';
export const DEFAULT_METADATA_TITLE = 'Lotactree';
export const DEFAULT_METADATA_DESCRIPTION = 'Lotactree';
